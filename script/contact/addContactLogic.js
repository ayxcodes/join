...
function fetchContacts() {
  const url = "https://join-backend-7a8a9-default-rtdb.europe-west1.firebasedatabase.app/Data/Contacts.json";
...
function saveContact(contactId, email, name, phone) {
  const url = `https://join-backend-7a8a9-default-rtdb.europe-west1.firebasedatabase.app/Data/Contacts/contactId${contactId}.json`;
